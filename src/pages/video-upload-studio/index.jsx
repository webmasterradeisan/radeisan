...
const VideoUploadStudio = () => {
  ...
  const [autoGeneratedThumbnails, setAutoGeneratedThumbnails] = useState([]);
  ...
  const handleCustomThumbnailUpload = (file) => {
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {selectedFile && !uploadSuccess && (
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Thumbnail Selection - Solo mostrar la miniatura seleccionada */}
                    <div className="bg-card rounded-lg border p-6">
                      <h3 className="font-medium text-foreground mb-4">Miniatura</h3>
                      {selectedThumbnail && (
