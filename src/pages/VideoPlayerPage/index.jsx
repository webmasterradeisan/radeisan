...
// ============================================================================
// VIDEO PLAYER PAGE COMPLETO - Con todos los fixes
// ============================================================================
// ✅ Sistema de Dislikes integrado
// ✅ Mini-player móvil
// ✅ Avatar de usuario en comentarios
// ✅ Estructura correcta de BD
// ============================================================================
...
const VideoPlayerPage = () => {
  ...
  // ✅ Estados para mini-player móvil
  ...
  // ✅ NUEVO: Obtener avatar del usuario actual
  const [currentUserAvatar, setCurrentUserAvatar] = useState(null);

  useEffect(() => {
    if (user) {
      // Intentar obtener avatar de user_profiles
      const fetchUserAvatar = async () => {
        ...
        setCurrentUserAvatar(data?.avatar_url || user.user_metadata?.avatar_url || '/default-avatar.png');
      };
      fetchUserAvatar();
    }
  }, [user]);

  // ✅ SCROLL DETECTION para mini-player móvil
  useEffect(() => {
    if (!isMobile) return;
                  ...
                  {user ? (
                    <form onSubmit={handleSubmitComment} className="mb-6">
                      <div className="flex gap-3">
                        {/* ✅ Avatar del usuario actual corregido */}
                        <img
...
EOF
cat /home/claude/VideoPlayerPage_COMPLETE.jsx
Salida
